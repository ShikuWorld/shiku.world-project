...
use crate::core::module::{ModuleIO, ModuleInstanceId, ModuleName, SystemCommunicationIO};
...
pub type ModuleInstanceToModuleMap = HashMap<ModuleInstanceId, ModuleName>;
